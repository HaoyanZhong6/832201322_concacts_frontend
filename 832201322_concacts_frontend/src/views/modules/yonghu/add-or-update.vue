<template>
  <div>
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" label="联系人名" prop="yonghuming">
            <el-input v-model="ruleForm.yonghuming"
                      placeholder="联系人名" clearable></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.yonghuming" label="联系人名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming"
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" label="备注" prop="xingming">
            <el-input v-model="ruleForm.xingming"
                      placeholder="备注" clearable></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.xingming" label="备注" prop="xingming">
              <el-input v-model="ruleForm.xingming"
...
<script>
// 数字，邮件，手机，url，身份证校验
import {checkIdCard, isEmail, isIntNumer, isMobile, isNumber, isURL} from "@/utils/validate";
